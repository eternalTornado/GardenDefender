...
public class EarthGolem : MonoBehaviour
{
    ...
    [SerializeField] GameObject m_SmokeSFX;
    ...
    void Start()
    {
        ...
        GameObject smokeSFX = Instantiate(m_SmokeSFX, this.transform.position, Quaternion.Euler(90f, 0f, 0f));
        Destroy(smokeSFX.gameObject, 5f);
    }
